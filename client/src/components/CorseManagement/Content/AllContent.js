                        ...
                        <tbody>
                            ...
                            {filtered.slice(0).reverse().map((content) => {
                                return <tr >
                                    ...
                                    <td><Link to={"/course/view/" + content._id} className="Edit"> <i class="bi bi-gear-fill" fontSize="large"></i> </Link></td> 
                                    <td><Link to={"/course/view/" + content._id} className="Edit"> <i class="bi bi-arrow-right-circle-fill" fontSize="large"></i> </Link></td> 
