...
export default function ViewOneCourse() {
    ...
    useEffect(() => {
        async function getDetails() {
            try {
                const result = await (await axios.get(`http://localhost:8070/course/${id}`)).data.data
    ...
    function deleteCourse(e) {
        ...
        SoloAlert.confirm({
            ...
            onOk: async function () {
                ...
                try {
                    const result = (await axios.delete(`http://localhost:8070/course/${id}`)).status
                    console.log(result)
                ...
                <h3 style={{ marginTop:"100px"}}>COURSE-DETAILS</h3><hr />
                    <form class="row g-3 needs-validation" id="inputForm2" noValidate>
                        ...
                        <div class="col-md-6 position-relative">
                            ...
                            <input type="text" class="form-control" id="validationTooltip01" required defaultValue={name}
                        ...
                        <div class="col-12" id="btngrp" hidden={btngrpState1} style={{marginTop:"5%"}}>
                                ...
                                <button type="submit" class="btn btn-primary" onClick={(e) => { updateCourse(e) }}
                        ...
                        <div class="col-12" id="btngrp" hidden={btngrpState2}  style={{marginTop:"5%"}}>
                            ...
                            <button type="submit" class="btn btn-danger" onClick={(e) => { deleteCourse(e) }}><i class="fa fa-trash"></i>  DELETE</button>
                        </div>
                    </form>
            </div>
